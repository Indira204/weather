...
// GET THE CONDITIONS
weatherConditions.open('GET', '//api.openweathermap.org/data/2.5/weather?zip=84653,us&appid=100413ba5cdada17e9f0eea78fa9a19f&units=imperial', true);
...
// GET THE FORECARST
weatherForecast.open('GET', '//api.openweathermap.org/data/2.5/forecast?zip=84653,us&appid=100413ba5cdada17e9f0eea78fa9a19f&units=imperial', true);
...
if (weatherForecast.status === 200){
	...
	console.log(fObj);
        ...
        var icon_path = "//openweathermap.org/img/w/"
        +iconcode+".png";
